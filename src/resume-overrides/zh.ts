...
export const zhOverride: ResumeOverride = {
	...
	about: {
		bio: '我喜欢让复杂系统跑得更好——不管是建模机场车辆调度、优化工厂产线，还是用 AI 芯片做智能钢琴。目前在港理工读航空工程硕士，同时在深圳一家做 AI 乐器的创业公司做研发。之前在美的和柳工的工厂待过，了解产品在产线上是怎么一步步做出来的。本科毕设做机场仿真拿了优秀论文和创新奖，手上也有一些专利。我觉得最有意思的问题，往往在工程、数据和真实运营交汇的地方。',
		facts: [
