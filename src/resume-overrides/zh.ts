...
export const zhOverride: ResumeOverride = {
	...
	experience: {
		...
		items: [{
				...
				location: '深圳',
				bullets: [
					'基于华为昇腾 NPU 开发 3 个内部工作流自动化的 AI 应用场景，优化推理管线使处理延迟降低约 30%。',
					'提交 2 项专利：AI 驱动的流程优化和智能排程算法。',
					'用 Prompt Engineering 加速原型验证和代码调试，开发周期缩短约 40%。',
				],
			},{
				title: '科研助理 — 机场运行仿真',
				...
				location: '广州',
				bullets: [
					'基于 AnyLogic 搭建 50+ 辆机场特种车辆的多智能体仿真模型，覆盖 3 个空侧区域；避碰与路径规划算法用 Java + MySQL 实现。',
					'高峰场景（200+ 次/小时调度）下优化调度方案，仿真拥堵降低 35%，测试运行零碰撞。',
				...
				bullets: [
					...
					'线平衡分析识别 2 个关键瓶颈，再平衡方案将理论线体效率从 72% 提升至 85%。',
				],
			},{
				title: '制造运营实习生',
				org: '广西柳工机械股份有限公司',
